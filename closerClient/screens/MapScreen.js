		...
		this.setState(previousState => (
			{
				markers: [{
					...
					profileImgSource: require('../assets/images/mocks/profilePics/maayan.jpg'),
					strokeColor:'red'
				},
				{
					title: 'Poli Layfer',
					coordinates: {
						...
						longitude: parseFloat(this.state.location.coords.longitude)+0.00051,
					},
					profileImgSource: require('../assets/images/mocks/profilePics/poli.jpg'),
					strokeColor:'green'
				}, 
				{
					title: 'Nizan Uzan',
					coordinates: {
						latitude: parseFloat(this.state.location.coords.latitude)-0.00062,
						longitude: parseFloat(this.state.location.coords.longitude)-0.00035,
					},
					profileImgSource: require('../assets/images/mocks/profilePics/nizan.jpg'),
					strokeColor:'orange'
				}, 
				{
					title: 'Nati Bodinger',
					coordinates: {
						latitude: parseFloat(this.state.location.coords.latitude)-0.00096,
						longitude: parseFloat(this.state.location.coords.longitude)-0.00005,
					},
					profileImgSource: require('../assets/images/mocks/profilePics/nati.jpg'),
					strokeColor:'green'
				}, 
				{
					title: 'Ortal Livyatan',
					coordinates: {
						latitude: parseFloat(this.state.location.coords.latitude)-0.00054,
						longitude: parseFloat(this.state.location.coords.longitude)-0.00062,
					},
					profileImgSource: require('../assets/images/mocks/profilePics/ortal.jpg'),
					strokeColor:'red'
				}, 
				{
					title: 'Elina Frayerman',
					coordinates: {
						latitude: parseFloat(this.state.location.coords.latitude)+0.00020,
						longitude: parseFloat(this.state.location.coords.longitude)+0.00044,
					},
					profileImgSource: require('../assets/images/mocks/profilePics/elina.jpg'),
					strokeColor:'orange'
				}]
			}
		))
					...
					{this.state.markers.map(marker => (
						<MapView.Marker
							...
							<Image
								...
								style={{ height: 70, width: 70, borderRadius: 50,borderWidth: 2, borderColor: marker.strokeColor }}
							/>
						</MapView.Marker>
					))}
				</MapView>
