        ...
        const getUser = ({ access_token }) => {
            ...
            return fetch('https://api.linkedin.com/v2/me?projection=(id,firstName,lastName,profilePicture,maidenName,headline,localizedHeadline)', {
                ...
                .then((responseJson) => {
                    ...
                    // );
                    this.props.navigation.navigate('Map', responseJson);
                })
                .catch((error) => {
                    console.log(error);
                });
            ...
            <View style={styles.container}>
                <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
                    ...
                    <View style={styles.iconsContainer}>
                        ...
                        <TouchableOpacity onPress={signWithTikTok}>
                            <Image source={require('../assets/images/icons/tiktok.png')} style={styles.iconImage} />
                        </TouchableOpacity>
