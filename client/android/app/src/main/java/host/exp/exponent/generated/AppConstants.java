...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@maayanadmin/closer";
  public static final String SHELL_APP_SCHEME = "expfafe80a95acf4e0383932a536d3f2256";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@maayanadmin/closer", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40maayanadmin%2Fcloser%2F1.0.0%2Fece4c185a0203754a6a8dc73444d189a-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
